...
- [x] **Step 3: Verify the copied file matches its source** using SHA-256 after normalizing line endings to LF, confirm the shared directory count and README figures agree, and inspect the final diff. Do not run the test suite unless requested.
